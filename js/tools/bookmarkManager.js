...
class BookmarkManager { /*exported BookmarkManager*/
  ...
  constructor() {
    ...
    Listener.instance.subscribe(ListenerProviders.localStorage, bookmarkListeners.created, (v) => { this._bookmarkOnCreated_sbscrb(v); }, true);
    Listener.instance.subscribe(ListenerProviders.localStorage, bookmarkListeners.removed, (v) => { this._bookmarkOnRemoved_sbscrb(v); }, true);
    ...
    Listener.instance.subscribe(ListenerProviders.localStorage, bookmarkListeners.moved, (v) => { this._bookmarkOnMoved_sbscrb(v); }, true);
